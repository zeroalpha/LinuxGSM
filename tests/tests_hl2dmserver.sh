...
echo "Command: ./hl2dmserver start"
echo ""
# Allows for testing not on Travis CI
if [ ! -v TRAVIS ]; then
(
...
echo "Description:"
echo "displaying options messages."
echo "Command: ./hl2dmserver abc123"
echo ""
getopt="abc123"
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Command: ./hl2dmserver auto-install"
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
	BASH_XTRACEFD="5"
	set -x
...
echo "Command: ./hl2dmserver restart"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Command: ./hl2dmserver update"
requiredstatus="OFFLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Command: ./hl2dmserver force-update"
requiredstatus="OFFLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Command: ./hl2dmserver validate"
requiredstatus="OFFLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "${travisip}" >> "${configdirserver}/common.cfg"
...
echo "Command: ./hl2dmserver monitor"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Command: ./hl2dmserver details"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Description:"
echo "post details."
echo "Command: ./hl2dmserver postdetails"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Description:"
echo "run a backup."
echo "Command: ./hl2dmserver backup"
requiredstatus="ONLINE"
fn_setstatus
...
echo "Description:"
echo "detect glibc."
echo "Command: ./hl2dmserver detect-glibc"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Description:"
echo "detect ldd."
echo "Command: ./hl2dmserver detect-ldd"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
...
echo "Command: ./hl2dmserver detect-deps"
requiredstatus="ONLINE"
fn_setstatus
(
	exec 5>"${TRAVIS_BUILD_DIR}/dev-debug.log"
